...
describe("Authentication", () => {
    ...
    test('User is able to signup only once', async () => {
        ...
        expect(response.status).toBe(200); // First signup should succeed
      
        // Second signup request with the same username
        ...
        expect(updatedResponse.status).toBe(400); // Second signup should fail
      });
